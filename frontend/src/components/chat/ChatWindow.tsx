    ...
    <div className="h-full border-2 border-[#1ABC9C] bg-[#0a0a0a] flex flex-col">
      ...
      <div className="p-3 border-b-2 border-[#1ABC9C] bg-[#1ABC9C]/10 flex items-center justify-between">
        <div className="flex items-center gap-3">
          {conversation.isLive && (
            <div className="flex items-center gap-1 px-2 py-0.5 bg-[#E74C3C] text-[#0a0a0a]">
        ...
        <div className="flex items-center gap-2 text-[10px] font-mono text-[#555]">
          <span>{conversation.participants.length} users</span>
          {conversation.type === "group" && (
            <>
              <span>|</span>
              <span className="text-[#1ABC9C]">1,337 watching</span>
            </>
          )}
        </div>
      </div>
